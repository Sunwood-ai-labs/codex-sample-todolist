...
diff --git a/docs-site/babel.config.js b/docs-site/babel.config.js
new file mode 100644
index 0000000..e00595d
--- /dev/null
+++ b/docs-site/babel.config.js
@@ -0,0 +1,3 @@
+module.exports = {
...
+  "version": "0.0.0",
+  "private": true,
+  "homepage": "https://Sunwood-ai-labs.github.io/codex-sample-todolist/",
+  "scripts": {
...
new file mode 100644
index 0000000..16f820b
--- /dev/null
+++ b/docs-site/src/components/HomepageFeatures.js
@@ -0,0 +1,64 @@
...
--- /dev/null
+++ b/docs-site/src/components/HomepageFeatures.module.css
@@ -0,0 +1,11 @@
+.features {
+  display: flex;
+  align-items: center;
...
diff --git a/docs-site/static/.nojekyll b/docs-site/static/.nojekyll
new file mode 100644
index 0000000..e69de29
diff --git a/docs-site/static/img/docusaurus.png b/docs-site/static/img/docusaurus.png
new file mode 100644
index 0000000..f458149
Binary files /dev/null and b/docs-site/static/img/docusaurus.png differ
diff --git a/docs-site/static/img/favicon.ico b/docs-site/static/img/favicon.ico
new file mode 100644
index 0000000..c01d54b
Binary files /dev/null and b/docs-site/static/img/favicon.ico differ
...
\ No newline at end of file
diff --git a/docs-site/static/img/tutorial/docsVersionDropdown.png b/docs-site/static/img/tutorial/docsVersionDropdown.png
new file mode 100644
index 0000000..ff1cbe6
Binary files /dev/null and b/docs-site/static/img/tutorial/docsVersionDropdown.png differ
diff --git a/docs-site/static/img/tutorial/localeDropdown.png b/docs-site/static/img/tutorial/localeDropdown.png
new file mode 100644
index 0000000..d7163f9
Binary files /dev/null and b/docs-site/static/img/tutorial/localeDropdown.png differ
diff --git a/docs-site/static/img/undraw_docusaurus_mountain.svg b/docs-site/static/img/undraw_docusaurus_mountain.svg
new file mode 100644
index 0000000..431cef2
--- /dev/null
+++ b/docs-site/static/img/undraw_docusaurus_mountain.svg
@@ -0,0 +1,170 @@
...
+  </g>
+</svg>
diff --git a/docs-site/static/img/undraw_docusaurus_react.svg b/docs-site/static/img/undraw_docusaurus_react.svg
new file mode 100644
index 0000000..e417050
--- /dev/null
+++ b/docs-site/static/img/undraw_docusaurus_react.svg
@@ -0,0 +1,169 @@
...
+  </g>
+</svg>
diff --git a/docs-site/static/img/undraw_docusaurus_tree.svg b/docs-site/static/img/undraw_docusaurus_tree.svg
new file mode 100644
index 0000000..a05cc03
--- /dev/null
+++ b/docs-site/static/img/undraw_docusaurus_tree.svg
@@ -0,0 +1 @@
